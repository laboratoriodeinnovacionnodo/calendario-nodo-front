...
import { Plus, Pencil, Trash2, Eye, Calendar, Filter, X, RefreshCw } from 'lucide-react'
                  ...
                  <TableRow key={event.id}>
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {isAdmin && (
                          <>
                            <Link href={`/dashboard/events/new?clone=${event.id}`}>
                              <Button variant="ghost" size="icon" title="Regenerar evento">
        ...
        {events.length > 0 && (
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              Mostrando {startIndex + 1} a {Math.min(endIndex, events.length)} de {events.length} evento{events.length !== 1 ? 's' : ''}
            </p>
