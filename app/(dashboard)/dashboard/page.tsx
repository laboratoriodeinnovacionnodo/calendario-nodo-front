...
export default function DashboardPage() {
  ...
  const stats = {
    ...
    totalConvocatorias: allEvents
      .filter(e => e.tipoEvento === 'FINALIZADO')
      .reduce((sum, e) => sum + e.convocatoria, 0),
  }
      ...
      <div className="p-4 md:p-6 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{stats.totalConvocatorias}</div>
              <p className="text-xs text-muted-foreground mt-1">Total finalizados</p>
            </CardContent>
          </Card>
        </div>
                          ...
                          <div className="flex items-start gap-4 p-3 rounded-lg border border-border hover:bg-muted/50 transition-colors">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-1 flex-wrap">
                                ...
                                {event.convocatoria > 0 && (
                                  <Badge variant="secondary" className="shrink-0 text-xs">
                                    Conv. {event.convocatoria}
                                  </Badge>
                                )}
                              </div>
